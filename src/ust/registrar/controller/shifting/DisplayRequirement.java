 ...
 */
@WebServlet("/DisplayRequirement")
public class DisplayRequirement extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			 String s = "SELECT uploaded_file FROM shifters_requirements WHERE id = '"+pkey+"'";
			 String imgLen = "";
