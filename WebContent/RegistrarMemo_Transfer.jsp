...
<br>
 ...
 <fieldset>
      ...
      <table class="table table-striped table-sortable">
        ...
        <%
         try{
        	   String display_finalmemo = "SELECT * FROM transferees_indorsement INNER JOIN student_transfer on transferees_indorsement.transferee_id = student_transfer.userid WHERE transfer_transferring_approved = 'Approved'";
