...
<br>
       ...
       <%try { 
        ...
        while(rss.next()) {
       %>
       <h4>Congratulations! Welcome to <%=rss.getString("newprogram") %> at the <%=rss.getString("newcourse") %>. </h4>
        <center><h4>Good Luck, Thomasian!</h4></center>
       <%}}catch(SQLException e) {out.print(e);} %>
       <br>
       <br>
       <form action="https://myuste.ust.edu.ph/student/"><button type="submit" class="btn btn-lg btn-warning">Check Student Portal</button></form>
       </center>
          </div>
  </div>
</div>
