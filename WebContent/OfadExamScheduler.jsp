...
<br>
    ...
    <br>
          ...
          <li class="active"><a href="OfadExamScheduler.jsp">Shifters <% if(totalShiftersExam>0){ %> <span class="notification alert-notif"><%= totalShiftersExam %></span> <% } %></a></li>
          <li><a href="OfadExamScheduler2.jsp">Transferees <% if(totalTransfersExam>0){ %> <span class="notification alert-notif"><%= totalTransfersExam %></span> <% } %></a></li>
          </ul>
          ...
          <tr>
           ...
           <tr>
               ...
               <th><select name = "venueexam" class="form-control" required>
                <option value = "" selected disabled style="display:none;">Please select a venue</option>
               <% try{ 
