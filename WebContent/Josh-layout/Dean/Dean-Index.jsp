...
<div class="container">
            ...
            <table class="table">
               ...
               <tr>
                 ...
                 <td rowspan = "4"><center><img src="../images/dp.png" style="width:50%; height:50%;"></center></td>
               </tr>
               <tr>
    ...
    <li><a href="../Dean/Dean-Transactions.jsp">ENDORSEMENT</a>
       <ul class="submenu">
        <li><a href="">SHIFTERS</a></li>
        <li><a href="">TRANSFEREES</a></li>
      </ul>
