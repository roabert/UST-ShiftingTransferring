...
<title>Index | UST Secretary General</title>
</head>
<body>
...
<div class="container">
            ...
            <table class="table">
               ...
               <tr>
                 ...
                 <td rowspan = "3"><center><img src="../images/dp.png" style="width:50%; height:50%;"></center></td>
               </tr>
               <tr>
    ...
    <li><a href="../Student-Shifter/Student-Shifter-Shifting.jsp" >TRANSACTIONS</a></li>
    <li><a href="../Student-Shifter/Student-Shifter-Tracker.jsp">EXAM RESULTS</a>
       <ul class="submenu">
        <li><a href="">SHIFTERS</a></li>
        <li><a href="">TRANSFEREES</a></li>
      </ul>
   </li>
       <li><a href="../Student-Shifter/Student-Shifter-Tracker.jsp">ENDORSEMENT</a>
       <ul class="submenu">
        <li><a href="">SHIFTERS</a></li>
        <li><a href="">TRANSFEREES</a></li>
      </ul>
