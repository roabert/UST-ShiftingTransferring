...
<title>Tracker | UST Student-Transferee</title>
</head>
<body>
...
<br>
 ...
 <nav class="navigation">
  <ul class="mainmenu">
    ...
    <li><a href="../Student-Shifter/Student-Shifter-Shifting.jsp" >TRANSFERRING</a></li>
    <li><a href="../Student-Shifter/Student-Shifter-Tracker.jsp"class="active">TRACKER</a>
<!--       <ul class="submenu">
        <li><a href="">Tops</a></li>
