...
<title>Index | UST Student-Shifter</title>
</head>
<body>
...
<div class="container">
         ...
         <!-- <table class="table">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
            	...
            	<div>
            		<strong>Name</strong><input type="text" class="form-control" value="SAMPLE"  size="15" size="50" readonly>
            		<strong>ID</strong><input type="text" class="form-control" value="SAMPLE"  size="15" size="50" readonly>
            		<strong>Program</strong><input type="text" class="form-control" value="SAMPLE"  size="15" size="50" readonly>
            		<strong>Outgoing</strong><input type="text" class="form-control" value="SAMPLE"  size="15" size="50" readonly>
            		</div>
            </div>
