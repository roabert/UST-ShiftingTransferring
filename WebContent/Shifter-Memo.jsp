...
Student Number: <input type="text" class="form-control" id="fname" value = "<%=r.getString("studentid") %>" name="studentid" placeholder="Student Number" > Date: <input type="text" class="form-control" align="right" value = "<%=format.format(date) %>" name="date" placeholder="Date today" ><br><br>
