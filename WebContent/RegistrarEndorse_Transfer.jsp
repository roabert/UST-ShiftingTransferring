...
%>
 ...
 <div off-canvas="slidebar-1 left reveal">
    ...
    <ul class="submenu">
        ...
        <li><a href="RegistrarEndorse_Transfer.jsp" class="active"><span class="glyphicon glyphicon-cloud-download"></span> Transferees</a></li>
     ...
     <form action="RegistrarIndorseTransferProcess" method="post">
         ...
         <div class="modal-body"><br>
          ...
          <p>recommending approval of the application</p>
           <center>
          <textarea name="endorsement" rows="30" cols="60" placeholder="Endorsement Letter" style="margin: 0px; width: 606px; height: 227px;"></textarea><br><br>
