...
<title>Registrar | Approved Endorsements</title>
</head>
...
%>
 ...
 <li><a href="#" class="active"><span class="glyphicon glyphicon-check"></span> Endorsed Students</a>
    <ul class="submenu">
        ...
        <li><a href="RegistrarApprovedEndorse_Transfer.jsp" class="active"><span class="glyphicon glyphicon-cloud-download"></span> Transferees</a></li>
...
<div class="topnav">
  ...
  <fieldset>
      ...
      <table class="table table-striped table-sortable">
        ...
        <td><button href="#<%=rs.getString("transferee_id")+cout%>" class="fancybox btn">View Memo</button></td>
        <td><b><%=rs.getString("registrar_indorsed") %></b></td>
        </tr>
        <div id="<%=rs.getString("transferee_id")+cout %>" style="width:600px;display: none;">
